    ...
    <main>
        ...
        <section class="hero">
            <div class="hero-content"></div>
                ...
                <a href="./main-menu.php" class="primary-btn">Explore Our Menu</a>
            </div>
        </section>
        ...
        <section class="featured">
            ...
            <div class="cards">
                ...
                <div class="card">
                    ...
                    <a href="./main-menu.php" class="view-btn">View in Menu</a>
                </div>
        ...
        <section class="join">
            ...
            <a href="../pages/login-register.php" class="primary-btn">Create Account</a>
        </section>
